...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        {
            newNode.Prev = _tail; // Connect the prev of the new node to the current tail
            _tail.Next = newNode; // Connect the next of current tail to the new node
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // For any other location of 'value', need to connect 
                ...
                else
                {
                    ...
                    curr.Prev!.Next = curr.Next; // Connect the node containing 'value' to the new node
                }

                return; // We can exit the function after remove
            }
    ...
    {
        // TODO Problem 4
        // Search for all nodes that matche 'oldValue' by starting at the 
        // head of the list.
        Node? curr = _head;
        while (curr is not null)
        {
            ...
            {
                // Set the Data to be the new value
                curr.Data = newValue;
            }
            curr = curr.Next; // Go to the next node to search for 'value'
        }
        return; // after iterate all nodes
    }
