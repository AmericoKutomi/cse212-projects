...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with zero turns were removed from the queue instead of remaining in the queue.
    ...
    // Defect(s) Found: People with negative turns were removed from the queue instead of remaining in the queue.
